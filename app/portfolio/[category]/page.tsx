  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="px-6 md:px-10 lg:px-16 py-8 md:py-8">
        ...
        <Link
          href="/portfolio"
          className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-muted-foreground hover:text-foreground transition-colors mb-6 group"
        >
        ...
        <div className="flex flex-col gap-2 mb-6 md:mb-8">
          ...
          <p className="text-muted-foreground font-light max-w-xl leading-relaxed mt-1">
        ...
        {/* Other Categories */}
        <div className="mt-12 md:mt-16 border-t border-border/40 pt-10">
